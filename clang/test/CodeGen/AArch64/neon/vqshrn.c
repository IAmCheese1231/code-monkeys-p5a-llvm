...
// LLVM-LABEL: @test_vqshrn_high_n_s16(
// CIR-LABEL: @test_vqshrn_high_n_s16(
int8x16_t test_vqshrn_high_n_s16(int8x8_t a, int16x8_t b) {
// CIR: cir.call_llvm_intrinsic "aarch64.neon.sqshrn" {{.*}} : (!cir.vector<8 x !s16i>, !s32i) -> !cir.vector<8 x !s8i>

// LLVM-SAME: <8 x i8> {{.*}} [[A:%.*]], <8 x i16> {{.*}} [[B:%.*]]) {{.*}} {
// LLVM:      [[NARROW:%.*]] = call <8 x i8> @llvm.aarch64.neon.sqshrn.v8i8(<8 x i16> {{.*}}, i32 3)
// LLVM:      [[RES:%.*]] = shufflevector <8 x i8> [[A]], <8 x i8> [[NARROW]]
// LLVM-NEXT: ret <16 x i8> [[RES]]
  return vqshrn_high_n_s16(a, b, 3);
}

// LLVM-LABEL: @test_vqshrn_high_n_s32(
// CIR-LABEL: @test_vqshrn_high_n_s32(
int16x8_t test_vqshrn_high_n_s32(int16x4_t a, int32x4_t b) {
// CIR: cir.call_llvm_intrinsic "aarch64.neon.sqshrn" {{.*}} : (!cir.vector<4 x !s32i>, !s32i) -> !cir.vector<4 x !s16i>

// LLVM-SAME: <4 x i16> {{.*}} [[A:%.*]], <4 x i32> {{.*}} [[B:%.*]]) {{.*}} {
// LLVM:      [[NARROW:%.*]] = call <4 x i16> @llvm.aarch64.neon.sqshrn.v4i16(<4 x i32> {{.*}}, i32 9)
// LLVM:      [[RES:%.*]] = shufflevector <4 x i16> [[A]], <4 x i16> [[NARROW]]
// LLVM-NEXT: ret <8 x i16> [[RES]]
  return vqshrn_high_n_s32(a, b, 9);
}

// LLVM-LABEL: @test_vqshrn_high_n_s64(
// CIR-LABEL: @test_vqshrn_high_n_s64(
int32x4_t test_vqshrn_high_n_s64(int32x2_t a, int64x2_t b) {
// CIR: cir.call_llvm_intrinsic "aarch64.neon.sqshrn" {{.*}} : (!cir.vector<2 x !s64i>, !s32i) -> !cir.vector<2 x !s32i>

// LLVM-SAME: <2 x i32> {{.*}} [[A:%.*]], <2 x i64> {{.*}} [[B:%.*]]) {{.*}} {
// LLVM:      [[NARROW:%.*]] = call <2 x i32> @llvm.aarch64.neon.sqshrn.v2i32(<2 x i64> {{.*}}, i32 19)
// LLVM:      [[RES:%.*]] = shufflevector <2 x i32> [[A]], <2 x i32> [[NARROW]]
// LLVM-NEXT: ret <4 x i32> [[RES]]
  return vqshrn_high_n_s64(a, b, 19);
}

// LLVM-LABEL: @test_vqshrn_high_n_u16(
// CIR-LABEL: @test_vqshrn_high_n_u16(
uint8x16_t test_vqshrn_high_n_u16(uint8x8_t a, uint16x8_t b) {
// CIR: cir.call_llvm_intrinsic "aarch64.neon.uqshrn" {{.*}} : (!cir.vector<8 x !s16i>, !s32i) -> !cir.vector<8 x !u8i>

// LLVM-SAME: <8 x i8> {{.*}} [[A:%.*]], <8 x i16> {{.*}} [[B:%.*]]) {{.*}} {
// LLVM:      [[NARROW:%.*]] = call <8 x i8> @llvm.aarch64.neon.uqshrn.v8i8(<8 x i16> {{.*}}, i32 3)
// LLVM:      [[RES:%.*]] = shufflevector <8 x i8> [[A]], <8 x i8> [[NARROW]]
// LLVM-NEXT: ret <16 x i8> [[RES]]
  return vqshrn_high_n_u16(a, b, 3);
}

// LLVM-LABEL: @test_vqshrn_high_n_u32(
// CIR-LABEL: @test_vqshrn_high_n_u32(
uint16x8_t test_vqshrn_high_n_u32(uint16x4_t a, uint32x4_t b) {
// CIR: cir.call_llvm_intrinsic "aarch64.neon.uqshrn" {{.*}} : (!cir.vector<4 x !s32i>, !s32i) -> !cir.vector<4 x !u16i>

// LLVM-SAME: <4 x i16> {{.*}} [[A:%.*]], <4 x i32> {{.*}} [[B:%.*]]) {{.*}} {
// LLVM:      [[NARROW:%.*]] = call <4 x i16> @llvm.aarch64.neon.uqshrn.v4i16(<4 x i32> {{.*}}, i32 9)
// LLVM:      [[RES:%.*]] = shufflevector <4 x i16> [[A]], <4 x i16> [[NARROW]]
// LLVM-NEXT: ret <8 x i16> [[RES]]
  return vqshrn_high_n_u32(a, b, 9);
}

// LLVM-LABEL: @test_vqshrn_high_n_u64(
// CIR-LABEL: @test_vqshrn_high_n_u64(
uint32x4_t test_vqshrn_high_n_u64(uint32x2_t a, uint64x2_t b) {
// CIR: cir.call_llvm_intrinsic "aarch64.neon.uqshrn" {{.*}} : (!cir.vector<2 x !s64i>, !s32i) -> !cir.vector<2 x !u32i>

// LLVM-SAME: <2 x i32> {{.*}} [[A:%.*]], <2 x i64> {{.*}} [[B:%.*]]) {{.*}} {
// LLVM:      [[NARROW:%.*]] = call <2 x i32> @llvm.aarch64.neon.uqshrn.v2i32(<2 x i64> {{.*}}, i32 19)
// LLVM:      [[RES:%.*]] = shufflevector <2 x i32> [[A]], <2 x i32> [[NARROW]]
// LLVM-NEXT: ret <4 x i32> [[RES]]
